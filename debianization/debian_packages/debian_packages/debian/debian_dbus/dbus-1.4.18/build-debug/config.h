...
#define DBUS_BINDIR "/usr/lib/x86_64-linux-gnu/dbus-1.0/debug-build/bin"
...
#define DBUS_DAEMONDIR "/usr/lib/x86_64-linux-gnu/dbus-1.0/debug-build/bin"

/* Name of executable */
#define DBUS_DAEMON_NAME "dbus-daemon"

/* Directory for installing DBUS data files */
#define DBUS_DATADIR "/usr/lib/x86_64-linux-gnu/dbus-1.0/debug-build/share"
...
#define DBUS_LIBEXECDIR "/usr/lib/x86_64-linux-gnu/dbus-1.0/debug-build/lib/dbus-1.0"

/* Prefix for installing DBUS */
#define DBUS_PREFIX "/usr/lib/x86_64-linux-gnu/dbus-1.0/debug-build"
...
#define DBUS_TEST_LAUNCH_HELPER_BINARY "/home/rpmuser/debian/debian_dbus/dbus-1.4.18/build-debug/bus/dbus-daemon-launch-helper-test"
...
#define PACKAGE_STRING "dbus 1.4.18"
...
#define TEST_BUS_BINARY "/home/rpmuser/debian/debian_dbus/dbus-1.4.18/build-debug/bus/dbus-daemon"

/* Full path to test file test/test-exit in builddir */
#define TEST_EXIT_BINARY "/home/rpmuser/debian/debian_dbus/dbus-1.4.18/build-debug/test/test-exit"

/* Full path to test file test/data/invalid-service-files in builddir */
#define TEST_INVALID_SERVICE_DIR "/home/rpmuser/debian/debian_dbus/dbus-1.4.18/build-debug/test/data/invalid-service-files"

/* Full path to test file test/data/invalid-service-files-system in builddir
   */
#define TEST_INVALID_SERVICE_SYSTEM_DIR "/home/rpmuser/debian/debian_dbus/dbus-1.4.18/build-debug/test/data/invalid-service-files-system"

/* Full path to test file test/name-test/test-privserver in builddir */
#define TEST_PRIVSERVER_BINARY "/home/rpmuser/debian/debian_dbus/dbus-1.4.18/build-debug/test/name-test/test-privserver"

/* Full path to test file test/test-segfault in builddir */
#define TEST_SEGFAULT_BINARY "/home/rpmuser/debian/debian_dbus/dbus-1.4.18/build-debug/test/test-segfault"

/* Full path to test file test/test-service in builddir */
#define TEST_SERVICE_BINARY "/home/rpmuser/debian/debian_dbus/dbus-1.4.18/build-debug/test/test-service"

/* Full path to test file test/test-shell-service in builddir */
#define TEST_SHELL_SERVICE_BINARY "/home/rpmuser/debian/debian_dbus/dbus-1.4.18/build-debug/test/test-shell-service"

/* Full path to test file test/test-sleep-forever in builddir */
#define TEST_SLEEP_FOREVER_BINARY "/home/rpmuser/debian/debian_dbus/dbus-1.4.18/build-debug/test/test-sleep-forever"

/* Full path to test file test/data/valid-service-files in builddir */
#define TEST_VALID_SERVICE_DIR "/home/rpmuser/debian/debian_dbus/dbus-1.4.18/build-debug/test/data/valid-service-files"

/* Full path to test file test/data/valid-service-files-system in builddir */
#define TEST_VALID_SERVICE_SYSTEM_DIR "/home/rpmuser/debian/debian_dbus/dbus-1.4.18/build-debug/test/data/valid-service-files-system"
